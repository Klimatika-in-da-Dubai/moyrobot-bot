...
async def create_promocode_check_for_past_week(session: async_sessionmaker) -> None:
    ...
    promocodes = await PromocodeDAO(session).get_between_time(start_check, end_check)
