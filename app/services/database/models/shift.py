...
class OpenShift(Base):
    ...
    shampoo_count: Mapped[int] = mapped_column(default=0)
    foam_count: Mapped[int] = mapped_column(default=0)
    wax_count: Mapped[int] = mapped_column(default=0)
    shampoo_check: Mapped[bool] = mapped_column(default=False)
    foam_check: Mapped[bool] = mapped_column(default=False)
    wax_check: Mapped[bool] = mapped_column(default=False)
    napkins_check: Mapped[bool] = mapped_column(default=False)
    coins_check: Mapped[bool] = mapped_column(default=False)
