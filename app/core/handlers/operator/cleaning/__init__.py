...
from app.core.handlers.operator.cleaning.approve import approve_router

cleaning_router = Router()

cleaning_router.include_routers(menu_router, place_router, work_router, approve_router)
