...
from app.core.handlers.admin.users.list.mailing import mailing_router

list_router = Router()
list_router.include_routers(
    menu_router, selected_user_router, change_user_router, mailing_router
)
